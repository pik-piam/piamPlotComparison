...
R package **piamPlotComparison**, version **0.0.14**
...
Benke F, Schoetz C (2024). _piamPlotComparison: Create comparison plots for your model results_. R package version 0.0.14, <https://github.com/pik-piam/piamPlotComparison>.
